...
package node.sector_5.nodes.nodes_5_14
{
	...
	import mvc.models.Node_5_14_10_Model;
	...
	public class Node_5_14_10 extends Box
	{
		/** Модель */
		protected var _model:Model;
		
		public function Node_5_14_10()
		{
			init();
		}
		...
		{
			// Моdel
			_model = Node_5_14_10_Model.getModel();
			...
			_inputField = new Input(55, 17, Border.status);
			...
			// 1 коп.
			var string:String = TextValue.getInstance().getArray()[4][23];
			var format:Format = new FormatSubstring();
			_titleField = new Title(string, 35, 17, Border.status);
