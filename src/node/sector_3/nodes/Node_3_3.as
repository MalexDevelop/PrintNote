...
package node.sector_3.nodes
{
	...
	import mvc.models.Node_3_3_Model;
	
	import node.Box;
	
	import value.*;
	
	public class Node_3_3 extends Box
	{
		/** Модель */
		protected var _model:Model;
		
		public function Node_3_3()
		{
			init();
		}
		...
		{
			// Моdel
			_model = Node_3_3_Model.getModel();
			...
			// готівкою, грн.
			var string:String = TextValue.getInstance().getArray()[2][3];
