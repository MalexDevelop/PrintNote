...
package node.sector_3.nodes
{
	...
	import mvc.models.Node_3_9_Model;
	
	import node.Box;
	
	import value.*;
	
	public class Node_3_9 extends Box
	{
		/** Модель */
		protected var _model:Model;
		
		public function Node_3_9()
		{
			init();
		}
		...
		{
			// Моdel
			_model = Node_3_9_Model.getModel();
			...
			var string:String = TextValue.getInstance().getArray()[2][9];
			var format:Format = new FormatString();
			_titleField = new Title(string, 100, height, Border.status);
			...
			_inputField.y = height - _inputField.height;
