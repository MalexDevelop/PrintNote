...
package node.sector_3.nodes
{
	...
	import mvc.models.Node_3_6_Model;
	
	import node.Box;
	
	import value.*;
	
	public class Node_3_6 extends Box
	{
		/** Модель */
		protected var _model:Model;
		
		public function Node_3_6()
		{
			init();
		}
		...
		{
			// Моdel
			_model = Node_3_6_Model.getModel();
			...
			// надлишок, грн.
			var string:String = TextValue.getInstance().getArray()[2][5];
